...
function Sync(method, model, opts) {
    ...
    switch (method) {
      ...
      case "read":
        ...
        params.custompath && (params.url = params.url + params.custompath);
        ...
        apiCall(params, function(_response) {
            if (_response.success) {
                ...
                Ti.API.debug("[object Array]" == "check if no array: " + Object.prototype.toString.call(data));
                if (0 == ("[object Array]" === Object.prototype.toString.call(data))) {
